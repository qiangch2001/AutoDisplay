...
"background-color: transparent;"));
        ...
        page_display->setAutoFillBackground(false);
        page_display->setStyleSheet(QString::fromUtf8(""));
        screen = new QLabel(page_display);
        screen->setObjectName(QString::fromUtf8("screen"));
        screen->setGeometry(QRect(0, 0, 480, 272));
        screen->setStyleSheet(QString::fromUtf8("background-color:rgba(255, 255, 255, 0)"));
        screen->setPixmap(QPixmap(QString::fromUtf8(":/wallpaper.png")));
        screen->setScaledContents(true);
        overlay = new QWidget(page_display);
        overlay->setObjectName(QString::fromUtf8("overlay"));
        overlay->setGeometry(QRect(0, 0, 480, 272));
